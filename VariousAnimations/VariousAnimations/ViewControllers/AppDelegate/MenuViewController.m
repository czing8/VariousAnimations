...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (indexPath.row == 0) {
        ...
        LayerAnimationController * layerAnimationVC = [[LayerAnimationController alloc] init];
        navigationController.viewControllers = @[layerAnimationVC];
    }else if (indexPath.row == 2){
        
        TransAnimationController * transAnimationVC = [self getControllerWithStoryboardName:@"TransAnimation"];
        
        navigationController.viewControllers = @[transAnimationVC];
    }
